...
# create admin button
admin_btn = Button(root, text="Admin Functions", command=admin)
search_btn.grid(row=0, column=1, padx=10, pady=10, ipadx=30)
# commit changes
con.commit()
